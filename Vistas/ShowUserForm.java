...
public class ShowUserForm extends javax.swing.JDialog {
    ...
    public void actualizarEmpleado() {
        ...
        if (nombres.isEmpty()) {
            ...
            String query = "UPDATE `empleados` SET `nombreEmp`='" + nombres + "',`apellidos`='" + apellidos + "',`correo`='" + correo + "' WHERE idEmp = '" + Idempleado + "';";
            try {
    ...
    public void eliminarEmpleado() {
        int Idempleado = Integer.parseInt(txtIdempleado.getText());
        String query = "DELETE FROM `empleados` WHERE idEmp = " + Idempleado + " ;";
        try {
            connection = conexion.getConnection();
            st = connection.createStatement();
            st.executeUpdate(query);
